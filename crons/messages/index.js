...
const {personalizeTextMessage, getTimezones, sendInternationalSms, getTwilioNumber, sendUndeliveredMessage, sendDailyText} = require('../../modules/twilio');
...
const sendFirstDailySms = async () => {
  const userIdsWithSentFirstSms = (await Message.findAll({
    where: {
      type: MESSAGES_TYPES.DAILY
    },
    attributes: ['user_id'],
