...
const selectGuide = asyncHandler(async (req, res, next) => {
  const { body } = req;
  let { user } = req;
...
const getGuideDay = asyncHandler(async (req, res, next) => {
...
const acceptGuideDay = asyncHandler(async (req, res, next) => {
...
const visitGuideDay = asyncHandler(async (req, res, next) => {
...
const getGuideDaysForSlider = asyncHandler(async (req, res, next) => {
  const body = req.query;
  if (!body.guide_id) {
    res.sendStatus(400);
    return;
...
const resetGuide = asyncHandler(async (req, res, next) => {
  let user = req.user;
  const body = req.body;
...
const selectPrevious = asyncHandler(async (req, res, next) => {
  let user = req.user;
  const body = req.body;
