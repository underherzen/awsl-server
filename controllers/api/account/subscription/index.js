 ...
 */
const pauseSubscription = asyncHandler(async (req, res, next) => {
  let user = req.user;
...
const resetSubscription = asyncHandler(async (req, res, next) => {
  let user = req.user;
  const subscription = req.subscription;
...
const changePaymentMethod = asyncHandler(async (req, res, next) => {
  let user = req.user;
  const subscription = req.subscription;
  const body = req.body;
  try {
...
const remindAboutSubscriptionEnd = asyncHandler(async (req, res, next) => {
  const user = req.user;
  await User.update(
    {
...
const changeToDiscountPlan = asyncHandler(async (req, res, next) => {
...
const applyCouponToSubscription = asyncHandler(async (req, res, next) => {
